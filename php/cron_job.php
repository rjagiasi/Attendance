<?php
	...
	$labs = query("Select l.SubjectId, s.ClassId, l.BatchId, l.StaffId from Labs as l, Subjects as s where (l.Days & b'$days') > 0 and l.SubjectId = s.SubjectId group by (l.StaffId)");
	// echo $lects;
	// print_r($labs);
	// return;
	...
	$mailing_list = query("Select Email, Name from Staff where StaffId in (Select StaffId from Notifs group by StaffId having count(*) > 15)");
